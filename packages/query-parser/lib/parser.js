...
exports.QueryBuilder = exports.QueryParser = void 0;
class QueryParser {
  parse(query) {
  ...
  extractModifier(section, pattern) {
...
class QueryBuilder {
  ...
  addStream(source, selector, timeRange) {
    if (this.query) {
