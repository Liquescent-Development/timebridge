...
function peg$parse(input, options) {
  ...
  var peg$c8 = "AND";
  var peg$c9 = "NOT";
  var peg$c10 = "_exists_:";
  var peg$c11 = "_missing_:";
  var peg$c12 = ":";
  var peg$c13 = "TO";
  var peg$c14 = "*";
  var peg$c15 = ">=";
  ...
  var peg$c17 = ">";
  var peg$c18 = "<";
  var peg$c19 = "influxdb";
  var peg$c20 = "custom-adapter";
  var peg$c21 = ",";
  var peg$c22 = "=~";
  var peg$c23 = "!~";
  var peg$c24 = "!=";
  ...
  var peg$c32 = "unless";
  var peg$c33 = "within";
  var peg$c34 = "ignoring";
  var peg$c35 = "group_left";
  var peg$c36 = "group_right";
  var peg$c37 = "s";
  var peg$c38 = "m";
  var peg$c39 = "h";
  var peg$c40 = "d";
  ...
  var peg$e2 = peg$literalExpectation("events", false);
  ...
  var peg$e13 = peg$literalExpectation("_exists_:", false);
  var peg$e14 = peg$literalExpectation("_missing_:", false);
  ...
  var peg$e22 = peg$literalExpectation("influxdb", false);
  var peg$e23 = peg$literalExpectation("custom-adapter", false);
  ...
  var peg$e32 = peg$literalExpectation(" NOT ", false);
  var peg$e33 = peg$anyExpectation();
  var peg$e34 = peg$literalExpectation("on", false);
  var peg$e35 = peg$literalExpectation("and", false);
  var peg$e36 = peg$literalExpectation("or", false);
  var peg$e37 = peg$literalExpectation("unless", false);
  var peg$e38 = peg$literalExpectation("within", false);
  var peg$e39 = peg$literalExpectation("ignoring", false);
  var peg$e40 = peg$literalExpectation("group_left", false);
  var peg$e41 = peg$literalExpectation("group_right", false);
  var peg$e42 = peg$literalExpectation("s", false);
  var peg$e43 = peg$literalExpectation("m", false);
  var peg$e44 = peg$literalExpectation("h", false);
  var peg$e45 = peg$literalExpectation("d", false);
  ...
  var peg$e56 = peg$literalExpectation("sum", false);
  var peg$e57 = peg$literalExpectation("avg", false);
  var peg$e58 = peg$literalExpectation("min", false);
  var peg$e59 = peg$literalExpectation("max", false);
  var peg$e60 = peg$literalExpectation("count", false);
  var peg$e61 = peg$literalExpectation("rate", false);
  var peg$e62 = peg$literalExpectation("increase", false);
  var peg$e63 = peg$literalExpectation("topk", false);
  var peg$e64 = peg$literalExpectation("bottomk", false);
  var peg$e65 = peg$literalExpectation("by", false);
  var peg$e66 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false);

  var peg$f0 = function(func, grouping, query) {
      return {
        type: 'aggregation',
        function: func,
        groupBy: grouping || [],
  ...
  var peg$f1 = function(stream, filter) {
      return {
        type: 'direct',
        stream: stream,
        filter
  ...
  var peg$f2 = function(streams, filter) {
      const result = {
        type: 'correlation',
  ...
  var peg$f3 = function(first, rest) {  // Note the + instead of * to require at least one join
      return [first, ...rest.map(r => r[1])];
    };
  var peg$f4 = function(join, stream) {
      stream.join = join;
      return stream;
    };
  var peg$f5 = function(selector, duration) {
      return {
        type: 'database',
  ...
  var peg$f6 = function(source, selector, duration) {
  ...
  var peg$f23 = function(metric, matchers) {
      return {
        text: `${metric}{${matchers ? matchers.map(m => m.text).join(',') : ''}}`,
        parsed: { type: 'promql', metric, matchers: matchers || [] }
      };
    };
  var peg$f24 = function(metric) {
      return {
        text: metric,
        parsed: { type: 'promql', metric, matchers: [] }
      };
    };
  var peg$f25 = function() { return "influxdb"; };
  var peg$f26 = function() { return "custom-adapter"; };
  ...
  var peg$f30 = function(label, op, value) {
      return {
        text: `${label}${op}${value.raw}`,
        parsed: { label, op, value: value.value }
      };
    };
  var peg$f31 = function(s) { return { raw: s.raw, value: s.value }; };
  var peg$f32 = function(i) { return { raw: i, value: i }; };
  ...
  var peg$f37 = function(type, keys, modifiers) {
      const result = {
        type,
        keys: keys.keys,
  ...
  var peg$f42 = function(labels) {
      return { ignoring: labels };
    };
  var peg$f43 = function(group) {
      return { grouping: group };
    };
  var peg$f44 = function(side, labels) {
      return { side, labels: labels || [] };
    };
  var peg$f45 = function(side) {
      return { side, labels: [] };
    };
  var peg$f46 = function() { return 'left'; };
  var peg$f47 = function() { return 'right'; };
  var peg$f48 = function(first, rest) {
      return [first, ...rest.map(r => r[3])];
    };
  var peg$f49 = function(matchers) {
      return `{${matchers.map(m => m.text).join(',')}}`;
    };
  var peg$f50 = function(num, unit) { return num + unit; };
  ...
  var peg$f54 = function(char) { return char; };
